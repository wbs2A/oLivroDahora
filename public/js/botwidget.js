...
!function (t) {
  ...
  function y(t, e) {
    if (null !== t && void 0 !== t) if ("object" != _typeof(t) && (t = [t]), o(t)) for (var n = 0, r = t.length; r > n; n++) {
      e.call(null, t[n], n, t);
    } else for (var i in t) {
  ...
  function w() {
    function t(t, n) {
      e[n] = "object" == _typeof(e[n]) && "object" == _typeof(t) ? w(e[n], t) : t;
    }
  ...
  function r(t, e) {
    ...
    for (e && null != e.children && (U.length || U.push(e.children), delete e.children); U.length;) {
      if ((r = U.pop()) && void 0 !== r.pop) for (a = r.length; a--;) {
        U.push(r[a]);
  ...
  function d(t, e, n, o, r) {
    if ("className" === e && (e = "class"), "key" === e) ;else if ("ref" === e) n && n(null), o && o(t);else if ("class" !== e || r) {
      if ("style" === e) {
        if (o && "string" != typeof o && "string" != typeof n || (t.style.cssText = o || ""), o && "object" == _typeof(o)) {
  ...
  function y(t, e, n, o, r) {
    ...
    if (0 !== x) for (var _ = 0; x > _; _++) {
      u = e[_], p = null;
      var j = u.key;
      if (null != j) m && void 0 !== h[j] && (p = h[j], h[j] = void 0, m--);else if (!p && y > b) for (i = b; y > i; i++) {
  ...
  function _(t, e, n) {
    ...
    for (o in e) {
      "children" === o || "innerHTML" === o || o in n && e[o] === ("value" === o || "checked" === o ? t[o] : n[o]) || d(t, o, n[o], n[o] = e[o], H);
    }
  }
  ...
  function C(t, e, n) {
    var o,
        r = W[t.name];
    if (t.prototype && t.prototype.render ? (o = new t(e, n), N.call(o, e, n)) : (o = new N(e, n), o.constructor = t, o.render = j), r) for (var i = r.length; i--;) {
  ...
  function S(t, e, n, o) {
    if (!t._disable) {
      ...
      if (!m || n ? L.unshift(t) : _ || (t.componentDidUpdate && t.componentDidUpdate(l, d, h), T.afterUpdate && T.afterUpdate(t)), null != t._renderCallbacks) for (; t._renderCallbacks.length;) {
  ...
  function E(t, e, n, o) {
    for (var r = t && t._component, i = r, a = t, s = r && t._componentConstructor === e.nodeName, c = s, u = p(e); r && !c && (r = r._parentComponent);) {
  ...
  t.exports = o.isStandardBrowserEnv() ? function () {
    return {
      write: function write(t, e, n, r, i, a) {
        var s = [];
...
/***/ 7:
/*!*****************************************!*\
  !*** multi ./resources/js/botwidget.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\oLivroDahora\resources\js\botwidget.js */"./resources/js/botwidget.js");
