        ...
        <div class="row">
            <div class="owl-carousel home-banner-owl">
                <div class="banner-img">
                    <img class="img-fluid" src="{{asset("img/banner/b1.jpg")}}" alt="" />
                ...
                <div class="banner-img">
                    <img class="img-fluid" src="{{asset("img/banner/b2.jpg")}}" alt="" />
                    <div class="text-wrapper">
                        <a href="#" class="d-flex">
                            <h1>
                                Make the world a better place <br />
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        ...
                                        src="{{asset("img/blog-post/blog-post1.jpg")}}"
                                        alt=""
                                />
                            </div>
                        ...
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post3.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                        ...
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post5.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                        ...
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post7.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post2.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                        ...
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post4.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                        ...
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post6.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                        ...
                        <div class="single-amenities">
                            <div class="amenities-thumb">
                                <img
                                        class="img-fluid w-100"
                                        src="{{asset("img/blog-post/blog-post8.jpg")}}"
                                        alt=""
                                />
                            </div>
                            <div class="amenities-details">
                    ...
                    <div class="single-sidebar-widget popular-post-widget">
                        ...
                        <div class="popular-post-list">
                            <div class="single-post-list">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{asset("img/blog/pp1.jpg")}}" alt="">
                                </div>
                            ...
                            <div class="single-post-list">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{asset("img/blog/pp2.jpg")}}" alt="">
                                </div>
                                <div class="details mt-20">
                                    <a href="blog-single.html">
                            ...
                            <div class="single-post-list">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{asset("img/blog/pp3.jpg")}}" alt="">
                                </div>
                                <div class="details mt-20">
                                    <a href="blog-single.html">
                            ...
                            <div class="single-post-list">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{asset("img/blog/pp4.jpg")}}" alt="">
                                </div>
                                <div class="details mt-20">
                                    <a href="blog-single.html">
